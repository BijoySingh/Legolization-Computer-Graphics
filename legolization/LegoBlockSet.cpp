...
#include "LegoBlockSet.h"
#include "LegoBlock.h"

bool LegoBlockSet::can_merge(LegoBlock *b1, LegoBlock *b2) {
...
bool LegoBlockSet::can_colors_merge(LegoBlock *b1, LegoBlock *b2) {
    return (b1->ignore_color
            || b2->ignore_color
            || (b1->r == b2->r && b1->g == b2->g && b1->b == b2->b));
}

bool LegoBlockSet::are_connected(LegoBlock *b1, LegoBlock *b2) {
    return is_stacked_on(b1, b2) || is_stacked_on(b2, b1);
}

bool LegoBlockSet::is_stacked_on(LegoBlock *b1, LegoBlock *b2) {
...
int LegoBlockSet::get_merge_color(LegoBlock *b1, LegoBlock *b2) {
...
LegoBlock *LegoBlockSet::merge(LegoBlock *b1, LegoBlock *b2) {
